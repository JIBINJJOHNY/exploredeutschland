    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('confirmed', 'Confirmed'), ('canceled', 'Canceled')], default='pending', max_length=20, verbose_name='Booking Status')),
                ...
                ('package', models.ForeignKey(help_text='Select the package for the booking', on_delete=django.db.models.deletion.CASCADE, to='package.pack', verbose_name='Package')),
